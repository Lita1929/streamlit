...
def data_preprocessing(data):
    ...
    df["Age_at_enrollment"] = transformer_Age_at_enrollment.transform(
        np.asarray(data["Age_at_enrollment"]).reshape(-1, 1))[0]
